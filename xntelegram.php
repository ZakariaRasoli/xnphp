    ...
    static function getMessage($chat, $message)
    {
        try {
            ...
            if ($forward) {
                ...
                $forwarduser = explode('/', $forwarduser);
                $forwarduser = end($forwarduser);
                $forward = $forwardname ? [
                    "title" => $forwardname,
            ...
            if (isset($video[0])) {
                ...
                $video = $pr[1];
                $videoduration = $video->getElementsByTagName("time")[0]->nodeValue;
...
class PWRTelegram
{
    ...
    public function createChat($title, $users, $level = 2)
    {
    ...
    public function uninstallStickerSet($stickerset, $level = 2)
    {
